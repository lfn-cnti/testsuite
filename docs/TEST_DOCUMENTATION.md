...
Checks if Kubernetes secrets are encrypted in the platform.  
Expectation: Secrets should be encrypted to ensure sensitive data is not stored in plain text.
